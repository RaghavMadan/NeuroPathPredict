...
input_dir = "/Users/raghav_m/Desktop/NeuroPathPredict/NeuroPathPredict/EucDistTransform/output/1_thres"
print(f'input dir: {input_dir}')
out_dir = "/Users/raghav_m/Desktop/NeuroPathPredict/NeuroPathPredict/EucDistTransform/output/2_bin"
...
for file in files:
    ...
    out_fl_nm = f'{name}_bin.nii'
    out_fl = join(out_dir,out_fl_nm)

    mv_pr_fl = join(mv_pr_dir,file)

    subprocess.run(["fslmaths", input_file, "-bin", out_fl])

    #subprocess.run(["mv", input_file, out_fl])
